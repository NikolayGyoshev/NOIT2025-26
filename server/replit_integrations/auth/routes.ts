...
import { registerUser, loginUser, ensureAdminUser, ensureDefaultUser } from "./passwordAuth";
import { z } from "zod";
...
export function registerAuthRoutes(app: Express): void {
  ...
  ensureDefaultUser().catch((error) => {
    console.warn("Failed to ensure default user:", error instanceof Error ? error.message : error);
  });
